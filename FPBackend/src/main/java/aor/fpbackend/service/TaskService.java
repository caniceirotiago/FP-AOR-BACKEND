...
public class TaskService {
    ...
    public void addUserToTask(@Valid TaskAddUsersDto taskAddUsersDto) throws EntityNotFoundException, InputValidationException {
        taskBean.addUserTask(taskAddUsersDto);
    }
