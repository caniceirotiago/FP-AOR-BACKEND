...
@NamedQuery(name = "Configuration.getAllConfiguration", query = "SELECT new aor.fpbackend.dto.Configuration.ConfigurationGetDto(c.configKey, c.value) FROM ConfigurationEntity c")
